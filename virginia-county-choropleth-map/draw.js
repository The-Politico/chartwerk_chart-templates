function draw(){
    var initialProps = {
        dims: {
          single: { width: 270, height: 125 },
          double: { width: 580, height: 250}
        },
    };
    ...
    d3.json("https://www.politico.com/interactives/elections/data/geography/2016/state/51/counties.json", function(error, geoData){
